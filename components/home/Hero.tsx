...
export function Hero() {
  return (
    <section className="relative -mt-24 md:-mt-32 h-[100svh] min-h-[680px] max-h-[920px] w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-noir)]/85 via-[var(--color-noir)]/45 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-noir)]/70 via-transparent to-[var(--color-noir)]/20" />
      </div>
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-[1320px] h-full px-6 md:px-10 flex items-center">
        <div className="max-w-2xl text-[var(--color-ivory)]">
          ...
          <motion.h1
            ...
            className="font-[family-name:var(--font-display)] text-5xl md:text-7xl lg:text-[5.5rem] font-light leading-[0.98] tracking-tight"
          >
          ...
          <motion.p
            ...
            className="mt-7 text-base md:text-lg text-[var(--color-ivory)]/82 leading-relaxed max-w-lg font-light"
          >
          ...
          >
            <Link href="/collections">
              <Button variant="gold" size="lg" iconRight={<Icon name="arrow-right" size={16} />}>
            ...
            <Link href="/visual-search">
              <Button
                variant="outline"
                size="lg"
                className="!text-[var(--color-ivory)] !ring-[rgba(255,255,255,0.35)] hover:!bg-[var(--color-ivory)]/10 hover:!text-[var(--color-ivory)]"
          ...
          <motion.div
            ...
            className="mt-12 flex flex-wrap items-center gap-x-8 gap-y-3 text-[11px] uppercase tracking-[0.3em] text-[var(--color-ivory)]/65"
          >
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-[var(--color-ivory)]/65 text-[10px] tracking-[0.4em]"
      >
